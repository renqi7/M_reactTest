#! /usr/bin/env node
// 添加数据  执行populatedb mongodb://数据库地址
...
const Book = require('./locallibrary/models/book');
const Author = require('./locallibrary/models/author');
const Genre = require('./locallibrary/models/genre');
const BookInstance = require('./locallibrary/models/BookInstance');
